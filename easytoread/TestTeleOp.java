...
public class TestTeleOp extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        //sets the motors to variables for code and phone use
        ...
        //sets the direction of the motors at the beggining of the program (can be changed later)
        ...
        //Sets the initilization position of the servos
        ...
        //While the play button is pressed run below code
        while (opModeIsActive()) {

            //sets empty power variables
            double leftPower;
            double rightPower;
            double liftPower;
