...
//keep all the imports, be VERY cautous when importing new packets
...
//stating that this class is a linear opmode
@TeleOp(name="Basic: Linear OpMode", group="Linear Opmode")
public class MyFirstOpMode extends LinearOpMode {


    /* Declare OpMode members. */
    //Setting the motors as empty variables for later use, also useless telemetry is there too...
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            //Controller mapping to all of the motors and servos
            ...
            //"turbo" mode where if "a" is pressed the motors get maxed in power
            if(turbo) {
